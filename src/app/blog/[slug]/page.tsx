...
export default async function BlogArticle({params}:{params:{slug:string}}){
    ...
    return (
        <div className="mt-8">
            <h1>
                <span className="block text-base text-center tect-primary font-semibold tracking-wide uppercase">
                    Huzefa Khan - Blog</span>
            ...
            priority  className="rounded-lg mt-8 border"/>
            <div className="mt-16 prose prose-blue prose-lg dark:prose-invert prose-li:marker:text-primary prose-a:text-primary">
                <PortableText value={data.content}/></div>
        </div>
    );}
